...
export default function DashboardClient({ userName }: Props) {
  ...
  return (
    <div className="p-5">
      <h1 className="font-bold text-3xl">{getGreeting()}, <span className="text-purple-600">{userName}</span> </h1>
      <p className="text-gray-600">
        Buat anggaran, atur keuangan, dan pantau pengeluaran Anda dengan mudah menggunakan <span className="text-purple-600 font-bold">expense tracker</span>.
      </p>
